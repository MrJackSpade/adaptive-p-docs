...
<table>
<tr>
<td width="50%">**[Image]** *(File: temperature_long.png)*<br><em>Temperature uniformly scales: low temp favors high-p, high temp flattens everything.</em></td>
<td width="50%">**[Image]** *(File: target_long.png)*<br><em>Adaptive-P creates a controllable peak at the target probability.</em></td>
</tr>
</table>
...
<table>
<tr>
<td width="50%"><strong>XTC Redistribution:</strong><br>**[Image]** *(File: xtc_fat_tail.png)*<br><em>XTC: All tail tokens get boosted (green lines up).</em></td>
<td width="50%"><strong>Adaptive-P:</strong><br>**[Image]** *(File: adaptive_no_tail.png)*<br><em>Adaptive-P: Only near-target tokens boosted; tail suppressed.</em></td>
</tr>
</table>
...
**[Image: Adaptive-P transformation curve showing bell curves centered at targets 0.3, 0.5, and 0.7]** *(File: g7_bell_curve.png)*
...
<table>
<tr>
<td width="50%">**[Image]** *(File: g8a_forced.png)*<br><em>Pattern A: Single token forced selection</em></td>
<td width="50%">**[Image]** *(File: g8b_binary.png)*<br><em>Pattern B: Binary split (94% vs 6%)</em></td>
</tr>
<tr>
<td width="50%">**[Image]** *(File: g8c_gap.png)*<br><em>Pattern C: Gap in middle (no tokens near target)</em></td>
<td width="50%">**[Image]** *(File: g8d_full.png)*<br><em>Pattern D: Full range (0.0 to 1.0)</em></td>
</tr>
</table>
...
**[Image: Transformation function shape showing quadratic core transitioning to linear tails]** *(File: g10_transform_shape.png)*
...
**[Image: Pre vs post softmax comparison showing logits and probabilities]** *(File: g12_softmax.png)*
...
<table>
<tr>
<td width="50%"><strong>Bad initialization (naive):</strong><br>**[Image]** *(File: bad_init.png)*<br><em>Naive init: Target drops to 0, takes ~100 tokens to recover.</em></td>
...
<table>
<tr>
<td width="50%">**[Image]** *(File: target_long.png)*<br><em>Target effect: Lower targets peak earlier; higher targets stay closer to natural predictions.</em></td>
<td width="50%">**[Image]** *(File: decay_long.png)*<br><em>Decay effect: Higher decay produces sharper peaks around target.</em></td>
</tr>
</table>
...
<table>
<tr>
<td width="50%">**[Image]** *(File: target_0.3.png)*<br><em>Target 0.3: Selections cluster around 0.3–0.4, avoiding high-probability tokens.</em></td>
<td width="50%">**[Image]** *(File: target_0.5.png)*<br><em>Target 0.5: Selections favor mid-range (0.5–0.7).</em></td>
</tr>
<tr>
<td width="50%">**[Image]** *(File: target_0.7.png)*<br><em>Target 0.7: Selections shift toward 0.7–1.0.</em></td>
<td width="50%">**[Image]** *(File: target_1.0.png)*<br><em>Target 1.0: Nearly greedy—almost all at p=1.0.</em></td>
</tr>
</table>
...
<table>
<tr>
<td width="50%">**[Image]** *(File: target_d0.5.png)*<br><em>Decay 0.5: Large oscillations (fishtailing).</em></td>
<td width="50%">**[Image]** *(File: target_d0.9.png)*<br><em>Decay 0.9: Balanced responsiveness.</em></td>
</tr>
<tr>
<td colspan="2" align="center" width="50%">**[Image]** *(File: target_d0.99.png)*<br><em>Decay 0.99: Very tight oscillations—nearly flat.</em></td>
</tr>
</table>
